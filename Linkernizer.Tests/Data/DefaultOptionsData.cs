...
internal sealed class DefaultOptionsData : TheoryData<string?, string?>
{
  ...
  public DefaultOptionsData()
  {
    ...
    Add("www.example.org:80/", """<a href="https://www.example.org:80/">www.example.org:80/</a>""");
    Add("https://www.example.org:80/", """<a href="https://www.example.org:80/">https://www.example.org:80/</a>""");
    Add("www.example.com:8080", """<a href="https://www.example.com:8080">www.example.com:8080</a>""");
    ...
    Add("https://user:pass@www.example.org/example", """<a href="https://user:pass@www.example.org/example">https://user:pass@www.example.org/example</a>""");
    Add("https://www.example.com@www.example.org/example", """<a href="https://www.example.com@www.example.org/example">https://www.example.com@www.example.org/example</a>""");
    Add("https://[2001:db8::1]:8080/example", """<a href="https://[2001:db8::1]:8080/example">https://[2001:db8::1]:8080/example</a>""");
